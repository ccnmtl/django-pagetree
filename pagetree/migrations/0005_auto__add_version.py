...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pagetree_version', (
            ...
            ('activity', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True)),
        ...
        db.send_create_signal('pagetree', ['Version'])


    def backwards(self, orm):
        # Deleting model 'Version'
        db.delete_table('pagetree_version')
    ...
    models = {
        ...
        'pagetree.userpagevisit': {
            'Meta': {'object_name': 'UserPageVisit'},
