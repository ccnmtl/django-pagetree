...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageBlock.css_extra'
        db.add_column('pagetree_pageblock', 'css_extra',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PageBlock.css_extra'
        db.delete_column('pagetree_pageblock', 'css_extra')
