...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserLocation', fields ['hierarchy', 'user']
        db.create_unique('pagetree_userlocation', ['hierarchy_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserLocation', fields ['hierarchy', 'user']
        db.delete_unique('pagetree_userlocation', ['hierarchy_id', 'user_id'])
    ...
    models = {
        ...
        'pagetree.userlocation': {
            'Meta': {'unique_together': "(('user', 'hierarchy'),)", 'object_name': 'UserLocation'},
            'hierarchy': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pagetree.Hierarchy']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
