...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserPageVisit'
        db.create_table('pagetree_userpagevisit', (
            ...
            ('first_visit', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('last_visit', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('pagetree', ['UserPageVisit'])


    def backwards(self, orm):
        # Deleting model 'UserPageVisit'
        db.delete_table('pagetree_userpagevisit')
