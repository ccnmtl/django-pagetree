...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Section.show_toc'
        db.add_column('pagetree_section', 'show_toc',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Section.deep_toc'
        db.add_column('pagetree_section', 'deep_toc',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Section.show_toc'
        db.delete_column('pagetree_section', 'show_toc')

        # Deleting field 'Section.deep_toc'
        db.delete_column('pagetree_section', 'deep_toc')
